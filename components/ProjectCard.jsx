  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-xl
                 bg-neutral-900/50 dark:bg-neutral-900/50 light:bg-white
                 border border-neutral-800 dark:border-neutral-800 light:border-neutral-300
    ...
    >
      ...
      <div className="aspect-video overflow-hidden relative">
        ...
        {/* Gradient overlay on hover (Ahmed style) */}
      ...
      <div className="p-6 flex flex-col gap-3">
        <h4 className="text-lg font-bold dark:text-neutral-100 text-neutral-800">
          {project.title}
        </h4>

        <p className="text-sm dark:text-neutral-300 text-neutral-700 leading-relaxed">
