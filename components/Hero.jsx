  ...
  return (
    <section className="py-24 flex flex-col gap-6">
      ...
      <div className="flex gap-4 pt-4">
        <a href="#projects" className="px-5 py-3 rounded-md bg-cyan-500 hover:bg-cyan-400 text-neutral-900 font-semibold shadow">
          Explore Projects
        </a>
        <a href="#about" className="px-5 py-3 rounded-md border border-neutral-700 hover:border-cyan-400 font-semibold">
          Learn More
        </a>
      </div>
    </section>
