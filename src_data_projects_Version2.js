const projects = [
  ...
  },
  {
    ...
    description: 'Set of experimental modules examining memory behavior, lifecycle, and security surfaces—includes build scripts, pentest helper tools, and userspace read tests.',
  ...
  },
  {
    ...
    description: 'ESP32 + Raspberry Pi integration with motion & temperature sensing, LED indicators, and real-time data ingestion via IoT APIs for a responsive reflective interface.',
  ...
  },
  {
    ...
    description: 'Layered underground chambers channel excess irrigation water through natural filtration media (gravel, sand, charcoal) before reuse. Proposed sensorization (level & quality) with an IoT dashboard for efficiency insights.',
